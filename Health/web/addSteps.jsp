...
<body>
<h3><%=PreparedSuggestion.createSuggestion("steps", (int)session.getAttribute("user_id"))%></h3>
<form action="AddStepsServlet" method="post">
    <ul>
        <li>
        ...
        <li>
            ...
            <input type="text" id="DATA" name="steps"/>
        </li><br/>
