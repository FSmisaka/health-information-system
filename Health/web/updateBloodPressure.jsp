...
<%
    ...
    int data = (int)request.getAttribute("bloodPressure");
    Date date = (Date)request.getAttribute("date");
%>

<form action="DeleteBloodPressureServlet" method="post">
    <h2>删除记录</h2>
    <ul>
        <li>
...
<form action="UpdateBloodPressureServlet" method="post">
    <h2>更新记录</h2>
    <ul>
        <li>
        ...
        <li>
            <label for="DATA">血&nbsp&nbsp压: </label>
            <input type="text" id="DATA" name="bloodPressure" value=<%=data%> />
        </li><br/>
    </ul>
