...
<%
    ...
    double data = (double)request.getAttribute("bloodOxygen");  // 改
    Date date = (Date)request.getAttribute("date");
%>

<form action="DeleteBloodOxygenServlet" method="post">  <!-- 改 -->
    <h2>删除记录</h2>
    <ul>
        <li>
...
<form action="UpdateBloodOxygenServlet" method="post">  <!-- 改 -->
    <h2>更新记录</h2>
    <ul>
        <li>
        ...
        <li>
            <label for="DATA">血&nbsp&nbsp氧: </label>  <!-- 改 -->
            <input type="text" id="DATA" name="bloodOxygen" value=<%=data%> />  <!-- 改 -->
        </li><br/>
    </ul>
