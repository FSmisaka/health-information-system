...
<body>
<h3><%=PreparedSuggestion.createSuggestion("bloodPressure", (int)session.getAttribute("user_id"))%></h3>
<form action="AddBloodPressureServlet" method="post">
    <ul>
        <li>
        ...
        <li>
            ...
            <input type="text" id="DATA" name="bloodPressure"/>
        </li><br/>
