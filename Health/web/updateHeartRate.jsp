...
<%
    ...
    int data = (int)request.getAttribute("heartRate");
    Date date = (Date)request.getAttribute("date");
%>

<form action="DeleteHeartRateServlet" method="post">
    <h2>删除记录</h2>
    <ul>
        <li>
...
<form action="UpdateHeartRateServlet" method="post">
    <h2>更新记录</h2>
    <ul>
        <li>
        ...
        <li>
            <label for="DATA">心&nbsp&nbsp率: </label>
            <input type="text" id="DATA" name="heartRate" value=<%=data%> />
        </li><br/>
    </ul>
