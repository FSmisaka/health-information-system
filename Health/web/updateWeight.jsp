...
<%
    ...
    double data = (double)request.getAttribute("weight");  // 改
    Date date = (Date)request.getAttribute("date");
%>

<form action="DeleteWeightServlet" method="post">  <!-- 改 -->
    <h2>删除记录</h2>
    <ul>
        <li>
...
<form action="UpdateWeightServlet" method="post">  <!-- 改 -->
    <h2>更新记录</h2>
    <ul>
        <li>
        ...
        <li>
            <label for="DATA">体&nbsp&nbsp重: </label>  <!-- 改 -->
            <input type="text" id="DATA" name="weight" value=<%=data%> />  <!-- 改 -->
        </li><br/>
    </ul>
