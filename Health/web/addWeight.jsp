...
<body>
<h3><%=PreparedSuggestion.createSuggestion("weight", (int)session.getAttribute("user_id"))%></h3>
<form action="AddWeightServlet" method="post">  <!-- 改 -->
    <ul>
        <li>
        ...
        <li>
            ...
            <input type="text" id="DATA" name="weight"/>  <!-- 改 -->
        </li><br/>
