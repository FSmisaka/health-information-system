...
<body>
<h3><%=PreparedSuggestion.createSuggestion("bloodOxygen", (int)session.getAttribute("user_id"))%></h3>
<form action="AddBloodOxygenServlet" method="post">  <!-- 改 -->
    <ul>
        <li>
        ...
        <li>
            ...
            <input type="text" id="DATA" name="bloodOxygen"/>  <!-- 改 -->
        </li><br/>
