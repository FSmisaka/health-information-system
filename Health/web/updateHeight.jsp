...
<%
    ...
    double data = (double)request.getAttribute("height");
    Date date = (Date)request.getAttribute("date");
%>

<form action="DeleteHeightServlet" method="post">
    <h2>删除记录</h2>
    <ul>
        <li>
...
<form action="UpdateHeightServlet" method="post">
    <h2>更新记录</h2>
    <ul>
        <li>
        ...
        <li>
            <label for="DATA">身&nbsp&nbsp高: </label>
            <input type="text" id="DATA" name="height" value=<%=data%> />
        </li><br/>
    </ul>
