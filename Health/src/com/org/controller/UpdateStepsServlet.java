...
@WebServlet(name="UpdateStepsServlet", urlPatterns="/UpdateStepsServlet")
public class UpdateStepsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            boolean flag = DAOFactory.getIStepsDAOInstance().updateData(id, data, date);
            if (flag) {
