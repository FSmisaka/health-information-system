...
@WebServlet(name="UpdateHeartRateServlet", urlPatterns="/UpdateHeartRateServlet")
public class UpdateHeartRateServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            boolean flag = DAOFactory.getIHeartRateDAOInstance().updateData(id, data, date);
            if (flag) {
